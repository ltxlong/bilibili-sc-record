...
(async function() {
    ...
    let sc_welt_hide_in_edge_flag = false; // 是否记录板贴边隐藏
    const sc_edge_zone = 5; // 边缘触发区域
    ...
    function sc_create_left_right_edge_trigger_line() {
        // 创建左右贴边透明细线，用于记录板贴边隐藏后的显示
        const sc_edge_trigger_len = $(document).find('.sc_edge_trigger');
        if (sc_edge_trigger_len.length === 0) {
            $("<div>", {
    ...
    function sc_config_get_live_sc_to_danmu_show_use_bilibili_style_flag() {
        let sc_live_sc_to_danmu_show_use_bilibili_style_flag_get = unsafeWindow.localStorage.getItem('live_sc_to_danmu_show_use_bilibili_style_flag');
        if (sc_live_sc_to_danmu_show_use_bilibili_style_flag_get !== null && sc_live_sc_to_danmu_show_use_bilibili_style_flag_get !== 'null' && sc_live_sc_to_danmu_show_use_bilibili_style_flag_get !== '') {
            sc_live_sc_to_danmu_show_use_bilibili_style_flag = sc_live_sc_to_danmu_show_use_bilibili_style_flag_get === 'true';
        }
    }
    ...
    function sc_memory_get_store_mode_all(sc_all_memory_config_json) {
        ...
        sc_welt_hide_in_edge_flag = sc_all_memory_config['sc_welt_hide_in_edge_flag'] ?? false;
        ...
        sc_live_filter_2_sc_mode = sc_all_memory_config['sc_live_filter_2_sc_mode'] ?? 0;
    ...
    function sc_memory_get_store_mode_self(sc_self_memory_config_json) {
        ...
        sc_welt_hide_in_edge_flag = sc_self_memory_config['sc_welt_hide_in_edge_flag'] ?? false;
        ...
        sc_live_filter_2_sc_mode = sc_self_memory_config['sc_live_filter_2_sc_mode'] ?? 0;
        ...
        if (the_atn_sc_panel_fold_mode === 1) {
            ...
            if ((auto_target_oj.offset().left - (unsafeWindow.innerWidth / 2)) > 0) {
                if (the_atn_sc_panel_list_height === 0 || sc_side_fold_hide_list_ing_flag) {
                    auto_target_oj.css('left', -(the_atn_sc_rectangle_width - 22 - 72 + 10 + 62)); // 22 约为总padding, 72为侧折后的宽，10为一个padding
                } else {
                    auto_target_oj.css('left', -(the_atn_sc_rectangle_width - 22 - 72 + 10)); // 22 约为总padding, 72为侧折后的宽，10为一个padding
                }
            } else {
                if (the_atn_sc_panel_list_height === 0 || sc_side_fold_hide_list_ing_flag) {
                    auto_target_oj.css('left', 72);
                }
            }
    ...
    function sc_welt_hide_in_edge_store() {
        if (sc_memory === 2) {
            // 个记
            update_sc_memory_config('sc_welt_hide_in_edge_flag', sc_welt_hide_in_edge_flag, 'self');
        } else if (sc_memory === 3) {
            // 全记
            update_sc_memory_config('sc_welt_hide_in_edge_flag', sc_welt_hide_in_edge_flag, 'all');
        }
    }
    ...
    function sc_live_search_confirm_prev() {
        ...
        if (the_search_result_div) {
            ...
            the_search_result_div_clone.css('position', 'unset');
            the_search_result_div_clone.css('top', 'unset');
            the_search_result_div_clone.css('left', 'unset');
            let the_search_result_div_item_color = the_search_result_div_clone.css('background-color');
            the_search_result_div_item_color = change_color_opacity(the_search_result_div_item_color, sc_list_search_div_bg_opacity_range / 100);
            the_search_result_div_clone.css('background-color', the_search_result_div_item_color);
            ...
            let the_search_result_div_item_head_color = the_search_result_div_clone.find('.sc_msg_head').css('background-color');
            the_search_result_div_item_head_color = change_color_opacity(the_search_result_div_item_head_color, sc_list_search_div_bg_opacity_range / 100);
            the_search_result_div_clone.find('.sc_msg_head').css('background-color', the_search_result_div_item_head_color);
    ...
    function sc_live_other_config_store() {
        if (sc_memory === 2) {
            ...
            update_sc_memory_config('sc_live_filter_2_sc_mode', sc_live_filter_2_sc_mode, 'self');
        } else if (sc_memory === 3) {
            // 全记
            ...
            update_sc_memory_config('sc_live_filter_2_sc_mode', sc_live_filter_2_sc_mode, 'all');
        }
    }
    ...
    function sc_panel_list_height_config_apply() {
        ...
        // 消除：全屏事件，导致记录板高度飘变动画
        if (the_phc_sc_panel_fold_mode !== 0) {
            // 注意：非折叠最小化才显示
    ...
    function sc_switch_css(flag = false) {
        if (flag) {
            ...
            if (sc_switch_fullscreen === 6) { sc_switch_fullscreen = 0; }
            if (sc_switch === 6) { sc_switch = 0; }
        ...
        let the_sc_side_fold_show_class = sc_side_fold_custom_first_class;
        if (sc_side_fold_custom_each_same_time_flag) {
            the_sc_side_fold_show_class = sc_side_fold_custom_each_same_time_class;
        }

        // head
        $(document).find('.sc_msg_head').each(function() {
            if ($(this).parent().hasClass(the_sc_side_fold_show_class) && $(this).parent().css('width') !== '50px') {
                return true;
            }
        ...
        // item
        $(document).find('.sc_long_item').each(function() {
            if ($(this).hasClass(the_sc_side_fold_show_class) && $(this).css('width') !== '50px') {
                return true;
            }
            ...
            if (sc_live_sc_danmu_show_n <= the_sc_danmu_top_road_show_n_limit) {
                ...
                if (get_free_danmu_show_arr['the_free_danmu_show_flag']) {
                    ...
                    if (!sc_live_sc_routine_price_arr.includes(sc_special_sc_price)) {
                        if (sc_live_sc_low_price_arr.includes(sc_special_sc_price)) {
                            sc_special_sc_no_routine_pric_tip = '[￥' + sc_special_sc_price + ']';
                        } else {
    ...
    function update_sc_item(sc_data, realtime = true) {
        ...
        let sc_item_msg_head_bg_hide_class = '';
        if (sc_live_all_font_size_add > 0) {
        ...
        // 如果在侧折模式，并且设置了头像边框透明
        if (sc_live_side_fold_head_border_bg_opacity_flag && the_usi_sc_panel_side_fold_flag) {
        ...
        let sc_item_html = '<div class="sc_long_item sc_' + sc_uid + '_' + sc_start_timestamp + '" data-fold="0" data-start="'+ (sc_start_timestamp * 1000 + sc_last_item_sort)+'" style="'+ sc_msg_item_style_width +'background-color: '+ sc_background_bottom_color +';margin-bottom: 10px;'+ sc_item_show_animation + sc_msg_item_style_border_radius + box_shadow_css +'">'+
            '<div class="sc_msg_head '+ sc_item_msg_head_bg_hide_class +'" style="' + sc_background_image_html + 'height: 40px;background-color: '+ sc_background_color +';padding:5px;background-size: contain;background-repeat: no-repeat;background-position: right center;'+ sc_msg_head_style_border_radius +'">'+
    ...
    function sc_process_start() {
        ...
        sc_other_style.textContent = `
            ...
            .sc_hide_in_edge_left {
                transform: translateX(-105%);
            }
            .sc_hide_in_edge_right {
                transform: translateX(105%);
            }
            .sc_edge_trigger {
                position: fixed;
            ...
            .sc_edge_trigger_left {
                left: 0;
            }
            .sc_edge_trigger_right {
                right: 0;
            }
        `;
        ...
        function sc_handleFullscreenChange() {
            ...
            if (document.fullscreenElement ||
                ...
                // 消除侧折影响
                if (the_hfc_sc_panel_fold_mode !== 1) {
                    if (sc_side_fold_custom_first_class) { $(document).find('.' + sc_side_fold_custom_first_class).css('position', 'unset'); }
                    if (sc_side_fold_custom_first_timeout_id) { clearTimeout(sc_side_fold_custom_first_timeout_id); }

                    if (sc_side_fold_custom_each_same_time_class) { $(document).find('.' + sc_side_fold_custom_each_same_time_class).css('position', 'unset'); }
                    if (sc_side_fold_custom_each_same_time_timeout_id) { clearTimeout(sc_side_fold_custom_each_same_time_timeout_id); }
                }

                if (the_hfc_sc_panel_fold_mode === 0) {
                    let the_hfc_sc_circle = $(document).find('.sc_circle_fullscreen');
                    the_hfc_sc_circle.hide();
                ...
                if (sc_panel_fold_mode === 0) {
                    let the_hfc_sc_circle = $(document).find('.sc_long_circle');
                    the_hfc_sc_circle.hide();
                    the_hfc_sc_circle.fadeIn(1000);
                }
            }
        ...
        $(document).on('mouseenter', '.sc_msg_head', function(e) {
            ...
            if (($(this).offset().left - (unsafeWindow.innerWidth / 2)) > 0) {
                if (the_enter_sc_panel_list_height === 0 || sc_side_fold_hide_list_ing_flag) {
                    $(this).parent().css('left', -(the_enter_sc_rectangle_width - 22 - 72 + 10 + 62)); // 22 约为总padding, 72为侧折后的宽，10为一个padding
                } else {
        ...
        $(document).on('mouseleave', '.sc_msg_head', function() {
            ...
            if (sc_live_side_fold_head_border_bg_opacity_flag && the_leave_sc_panel_side_fold_flag) {
                const bg_color = $(this).css('background-color');
        ...
        // 判断记录板贴边隐藏
        $(document).on('mouseleave', '.sc_drag_div', function() {
            if (sc_welt_hide_in_edge_flag) {
                const rect = this.getBoundingClientRect();
                if (rect.left <= sc_edge_zone) {
                    $('.sc_drag_div').addClass('sc_hide_in_edge_left');
                } else if (rect.right >= unsafeWindow.innerWidth - sc_edge_zone) {
                    $('.sc_drag_div').addClass('sc_hide_in_edge_right');
                }
            }
        });

        // 判断鼠标贴边显示记录板
        // 同时添加mouseleave事件来优化滚动条的问题
        $(document).on('mouseenter mouseleave', '.sc_edge_trigger', function() {
            if (sc_welt_hide_in_edge_flag) {
                const trigger_side = $(this).hasClass("sc_edge_trigger_left")
                ? "left"
                : "right";

                const hide_side = $('.sc_drag_div').hasClass("sc_hide_in_edge_left")
                ? "left"
                : "right";

                if (trigger_side === hide_side) {
                    $('.sc_drag_div').removeClass('sc_hide_in_edge_left sc_hide_in_edge_right');
                }
            }
        });
        ...
        $(document).on('click', '#sc_live_sc_to_danmu_show_confirm_btn', function(e) {
            ...
            if (sc_live_sc_to_danmu_show_flag) {
                ...
                sc_live_sc_to_danmu_cache_arr = []; // 清空SC2弹幕缓存
        ...
        sc_live_other_modal_style.textContent = `
            ...
            .sc_live_other_filter_radio_group {
                display: inline-flex;
                color: #000;
                padding-top: 20px;
            }

            .sc_live_other_filter_radio_group_fullscreen {
                display: inline-flex;
                color: #000;
                padding-top: 20px;
            }
                ...
                <div class="sc_live_other_modal_content">
                    ...
                    <form id="sc_live_other_form">
                        ...
                        <div class="sc_live_other_checkbox_div">
                            ...
                            <label for="sc_live_other_fullscreen_auto_hide_list" class="sc_live_other_checkbox_inline sc_live_other_checkbox_the_label">侧折模式下，切换全屏时，自动隐藏醒目留言列表</label>
                            <input type="checkbox" id="sc_live_other_side_fold_head_border_bg_opacity_flag" class="sc_live_other_checkbox_inline"/>
                            <label for="sc_live_other_side_fold_head_border_bg_opacity_flag" class="sc_live_other_checkbox_inline sc_live_other_checkbox_the_label">侧折模式下，隐藏头像边框</label>
                        </div>
                        <div class="sc_live_other_checkbox_div">
                        ...
                        <div class="sc_live_other_checkbox_div">
                            <input type="checkbox" id="sc_live_other_welt_hide_circle_half_flag" class="sc_live_other_checkbox_inline"/>
                            <label for="sc_live_other_welt_hide_circle_half_flag" class="sc_live_other_checkbox_inline">设置小图标在贴边后半隐藏</label>
                        </div>
                        <div class="sc_live_other_checkbox_div">
                            <input type="checkbox" id="sc_live_other_welt_hide_in_edge_flag" class="sc_live_other_checkbox_inline"/>
                            <label for="sc_live_other_welt_hide_in_edge_flag" class="sc_live_other_checkbox_inline">设置记录板在贴边后隐藏</label>
                        </div>
                        <div class="sc_live_other_checkbox_div">
                        ...
                        <div class="sc_live_other_filter_radio_group">
                ...
                <div class="sc_live_other_modal_content">
                    ...
                    <form id="sc_live_other_form_fullscreen">
                        ...
                        <div class="sc_live_other_checkbox_div">
                            ...
                            <label for="sc_live_other_fullscreen_auto_hide_list_fullscreen" class="sc_live_other_checkbox_inline sc_live_other_checkbox_the_label">侧折模式下，切换全屏时，自动隐藏醒目留言列表</label>
                            ...
                            <label for="sc_live_other_side_fold_head_border_bg_opacity_flag_fullscreen" class="sc_live_other_checkbox_inline sc_live_other_checkbox_the_label">侧折模式下，隐藏头像边框</label>
                        </div>
                        <div class="sc_live_other_checkbox_div">
                        ...
                        <div class="sc_live_other_checkbox_div">
                            <input type="checkbox" id="sc_live_other_welt_hide_circle_half_flag_fullscreen" class="sc_live_other_checkbox_inline"/>
                            <label for="sc_live_other_welt_hide_circle_half_flag_fullscreen" class="sc_live_other_checkbox_inline">设置小图标在贴边后半隐藏</label>
                        </div>
                        <div class="sc_live_other_checkbox_div">
                            <input type="checkbox" id="sc_live_other_welt_hide_in_edge_flag_fullscreen" class="sc_live_other_checkbox_inline"/>
                            <label for="sc_live_other_welt_hide_in_edge_flag_fullscreen" class="sc_live_other_checkbox_inline">设置记录板在贴边后隐藏</label>
                        </div>
                        <div class="sc_live_other_checkbox_div">
                        ...
                        <div class="sc_live_other_filter_radio_group_fullscreen">
        ...
        $(document).on('click', '#sc_live_other_confirm_btn', function(e) {
            ...
            let sc_live_filter_2_sc_mode_select = $(document).find('.sc_live_other_filter_radio_group input[name="sc_live_other_filter_2_sc"]:checked').val();
            sc_live_filter_2_sc_mode = parseInt(sc_live_filter_2_sc_mode_select, 10);
            ...
            let the_ocb_sc_panel_side_fold_flag = sc_panel_side_fold_flag;
            if (sc_isFullscreen && sc_live_fullscreen_config_separate_memory_flag) {
                the_ocb_sc_panel_side_fold_flag = sc_panel_side_fold_flag_fullscreen;
            }

            if (sc_live_side_fold_head_border_bg_opacity_flag && the_ocb_sc_panel_side_fold_flag) {
                // head
                $(document).find('.sc_msg_head').each(function() {
                    if ($(this).parent().hasClass(the_sc_side_fold_show_class) && $(this).parent().css('width') !== '50px') {
                        return true;
            ...
            sc_welt_hide_circle_half_flag = $(document).find('#sc_live_other_welt_hide_circle_half_flag').is(':checked');
            sc_welt_hide_circle_half_store();

            if (sc_welt_hide_circle_half_flag) {
            ...
            sc_welt_hide_in_edge_flag = $(document).find('#sc_live_other_welt_hide_in_edge_flag').is(':checked');
            sc_welt_hide_in_edge_store();
            if (sc_welt_hide_in_edge_flag) {
        ...
        $(document).on('click', '#sc_live_other_confirm_btn_fullscreen', function(e) {
            ...
            let sc_live_filter_2_sc_mode_select = $(document).find('.sc_live_other_filter_radio_group_fullscreen input[name="sc_live_other_filter_2_sc_fullscreen"]:checked').val();
            sc_live_filter_2_sc_mode = parseInt(sc_live_filter_2_sc_mode_select, 10);
            ...
            sc_welt_hide_circle_half_flag = $(document).find('#sc_live_other_welt_hide_circle_half_flag_fullscreen').is(':checked');
            sc_welt_hide_circle_half_store();
            ...
            sc_welt_hide_in_edge_flag = $(document).find('#sc_live_other_welt_hide_in_edge_flag_fullscreen').is(':checked');
            sc_welt_hide_in_edge_store();
        ...
        function input_change_the_search_result_div_color_opacity(new_color) {
            let the_search_result_div_oj = $(document).find('.sc_live_search_result_div').first().children().first();
            let the_search_result_div_fullscreen_oj = $(document).find('.sc_live_search_result_div_fullscreen').first().children().first();
            let the_search_result_div_head_oj = the_search_result_div_oj.children().first();
            let the_search_result_div_head_fullscreen_oj = the_search_result_div_fullscreen_oj.children().first();

            let the_search_result_div_oj_color = the_search_result_div_oj.css('background-color');
            the_search_result_div_oj_color = change_color_opacity(the_search_result_div_oj_color, new_color / 100);
            let the_search_result_div_head_oj_color = the_search_result_div_head_oj.css('background-color');
            the_search_result_div_head_oj_color = change_color_opacity(the_search_result_div_head_oj_color, new_color / 100);

            the_search_result_div_oj.css('background-color', the_search_result_div_oj_color);
            the_search_result_div_head_oj.css('background-color', the_search_result_div_head_oj_color);
            the_search_result_div_fullscreen_oj.css('background-color', the_search_result_div_oj_color);
            the_search_result_div_head_fullscreen_oj.css('background-color', the_search_result_div_head_oj_color);
        }
        ...
        $(document).on('input', '.change_bg_opacity_range', function() {
            ...
            sc_change_bg_opacity_timeout = setTimeout(() => {
                ...
                input_change_the_search_result_div_color_opacity($(this).val());
            }, 1000);
        });
        ...
        $(document).on('click', '.sc_trash_danmu_cache_icon', function(e) {
            let the_tdc_sc_panel_side_fold_flag = sc_panel_side_fold_flag;
            if (sc_isFullscreen && sc_live_fullscreen_config_separate_memory_flag) {
                the_tdc_sc_panel_side_fold_flag = sc_panel_side_fold_flag_fullscreen;
            }
            ...
            // 侧折的SC展示
            if (the_tdc_sc_panel_side_fold_flag && sc_side_fold_custom_each_same_time_class) { sc_trigger_item_side_fold_in(sc_side_fold_custom_each_same_time_class); }
            if (the_tdc_sc_panel_side_fold_flag && sc_side_fold_custom_each_same_time_timeout_id) { clearTimeout(sc_side_fold_custom_each_same_time_timeout_id); }

            if (the_tdc_sc_panel_side_fold_flag && sc_side_fold_custom_first_class && !sc_live_sc_to_danmu_show_flag) {
                sc_side_fold_custom_auto_run_flag = false;
                sc_side_fold_custom_each_same_time_class = sc_side_fold_custom_first_class;
                sc_custom_config_apply(sc_side_fold_custom_first_class);
            }

            open_and_close_sc_modal('✓ 已清空 SC 缓冲队列', '#A7C9D3', e, 1);
        });
  ...
  "live_sc_all_memory_config": {
    ...
    "sc_welt_hide_in_edge_flag": false,
...
`;
        ...
        sc_func_button20.id = 'sc_func_live_sidebar_left_btn';
        sc_func_button20.innerHTML = '设置直播间功能按钮在左侧';
        ...
        sc_func_button21.id = 'sc_func_live_sidebar_right_btn';
        sc_func_button21.innerHTML = '恢复直播间功能按钮在右侧';
        ...
        sc_func_button22.id = 'sc_func_live_sc_to_danmu_show_btn';
        sc_func_button22.innerHTML = '设置醒目留言以弹幕来展现';
        ...
        sc_func_button23.id = 'sc_func_fullscreen_separate_memory_btn';
        sc_func_button23.innerHTML = '一些设置在全屏时分开记忆';
        ...
        $(document).on('click', '#sc_func_live_sc_to_danmu_show_btn', function(e) {
            ...
            $(document).find('#sc_live_sc_to_danmu_use_bilibili_style_checkbox').prop('checked', false);
            $(document).find('#sc_live_sc_to_danmu_use_bilibili_style_checkbox_fullscreen').prop('checked', false);
            if (sc_live_sc_to_danmu_show_use_bilibili_style_flag) {
        ...
        $(document).on('click', '#sc_func_live_other_config_btn', function(e) {
            ...
            let sc_live_other_welt_hide_circle_half_flag_checkbox_id = 'sc_live_other_welt_hide_circle_half_flag';
            let sc_live_other_welt_hide_in_edge_flag_checkbox_id = 'sc_live_other_welt_hide_in_edge_flag';
            ...
            let sc_live_other_config_filter_radio_option_name = 'sc_live_other_filter_2_sc';
            ...
            if (sc_isFullscreen) {
                ...
                sc_live_other_welt_hide_circle_half_flag_checkbox_id = 'sc_live_other_welt_hide_circle_half_flag_fullscreen';
                sc_live_other_welt_hide_in_edge_flag_checkbox_id = 'sc_live_other_welt_hide_in_edge_flag_fullscreen';
            ...
            $(document).find('#sc_live_other_welt_hide_circle_half_flag').prop('checked', false);
            $(document).find('#sc_live_other_welt_hide_circle_half_flag_fullscreen').prop('checked', false);
            if (sc_welt_hide_circle_half_flag) {
                $(document).find('#' + sc_live_other_welt_hide_circle_half_flag_checkbox_id).prop('checked', true);
            }

            $(document).find('#sc_live_other_welt_hide_in_edge_flag').prop('checked', false);
            $(document).find('#sc_live_other_welt_hide_in_edge_flag_fullscreen').prop('checked', false);
            if (sc_welt_hide_in_edge_flag) {
                $(document).find('#' + sc_live_other_welt_hide_in_edge_flag_checkbox_id).prop('checked', true);
            }
            ...
            $(document).find('.'+ sc_live_other_config_filter_radio_group_class +' input[name="'+ sc_live_other_config_filter_radio_option_name +'"]').eq(sc_live_filter_2_sc_mode).prop('checked', true);
